...
public class ArticleDetailFragment extends Fragment implements
    ...
    private int mMutedSwColor = 0xFF333333;
                    ...
                    .get(mCursor.getString(ArticleLoader.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                            ...
                            if (bitmap != null) {
                                ...
                                mMutedSwColor = p.getMutedColor(0xFF333333);
                                mVibrantColor = p.getVibrantColor(0xFF333333);
                                mPhotoView.setImageBitmap(imageContainer.getBitmap());
                                mRootView.findViewById(R.id.meta_bar).setBackgroundColor(mMutedSwColor);
                                collapsingToolbarLayout.setContentScrimColor(mMutedSwColor);
                                floatingActionButton.setBackgroundTintList(ColorStateList.valueOf(mVibrantColor));
                                try {
